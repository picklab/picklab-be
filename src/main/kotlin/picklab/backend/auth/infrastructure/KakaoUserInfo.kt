...
class KakaoUserInfo(
    ...
    override fun getName(): String? = attributes["properties"]?.get("nickname")?.asText()

    override fun getEmail(): String? = attributes["kakao_account"]?.get("email")?.asText()

    override fun getProfileImage(): String? = attributes["properties"]?.get("profile_image")?.asText()
