...
data class ActivityReviewResponse(
    ...
    val id: Long,
    @field:Schema(description = "총 평점", example = "4")
    val overallScore: Int,
    @field:Schema(description = "직무 경험 평점", example = "4")
    val infoScore: Int,
    @field:Schema(description = "활동 강도 평점", example = "3")
    val difficultyScore: Int,
    @field:Schema(description = "혜택 및 복지 평점", example = "5")
    val benefitScore: Int,
    @field:Schema(description = "직무", example = "기획")
    val jobGroup: JobGroup,
    @field:Schema(description = "리뷰 세부 직무 (null = 전체)", example = "서비스 기획")
    val jobDetail: JobDetail?,
    @field:Schema(description = "참여 날짜", example = "2024-01-01T12:00:00")
