...
class ReviewOverviewQueryService(
    ...
    fun findActivityReviews(
        filter: ActivityReviewListQueryRequest,
        activityId: Long,
        pageable: PageRequest,
    ): Page<ActivityReviewListItem> = reviewOverviewQueryRepository.findActivityReviewsWithFilter(filter, activityId, pageable)
}
