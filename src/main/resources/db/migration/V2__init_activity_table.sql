...
(
    ...
    series_id               BIGINT      NOT NULL COMMENT '활동 시리즈 ID',
    title                   VARCHAR(50) NOT NULL COMMENT '활동명',
    post_type               VARCHAR(50) NOT NULL COMMENT '활동 유형 (대외활동, 공모전/해커톤, 세미나, 교육)',
    ...
    activity_field          VARCHAR(50) COMMENT '대외활동 세부 분야',
    domain                  VARCHAR(50) COMMENT '공모전/해커톤 세부 분야',
    cost                    BIGINT      COMMENT '공모전(시상 규모), 교육(교육비용)',
