...
(
    ...
    education_cost_type         VARCHAR(50) COMMENT '교육 비용 유형 (무료, 유료, 전액 국비지원, 일부 국비지원)',
    education_format            VARCHAR(50) COMMENT '교육 형식 (온라인, 오프라인, 온/오프라인)',
    duration                    INTEGER     NOT NULL COMMENT '활동 기간(일)',
    activity_homepage_url       VARCHAR(255) COMMENT '활동 홈페이지 URL',
    activity_application_url    VARCHAR(255) COMMENT '활동 신청 URL',
    activity_thumbnail_url      VARCHAR(255) COMMENT '활동 썸네일 이미지 URL',
