                ...
                val given1 =
                    activityRepository.save(
                        ExternalActivity(
                            ...
                            recruitmentStartDate = LocalDate.of(2025, 6, 27),
                            recruitmentEndDate = LocalDate.of(2025, 7, 27),
                ...
                val given1 =
                    activityRepository.save(
                        EducationActivity(
                            ...
                            location = LocationType.SEOUL_INCHEON,
                            recruitmentStartDate = LocalDate.of(2025, 6, 27),
                            recruitmentEndDate = LocalDate.of(2025, 6, 30),
                            startDate = LocalDate.of(2025, 9, 1),
                            endDate = LocalDate.of(2025, 12, 31),
                            status = RecruitmentStatus.OPEN,
                            viewCount = 0L,
                ...
                val given2 =
                    activityRepository.save(
                        ExternalActivity(
                            ...
                            location = LocationType.SEOUL_INCHEON,
                            recruitmentStartDate = LocalDate.of(2025, 6, 27),
                            recruitmentEndDate = LocalDate.of(2025, 6, 27),
                            startDate = LocalDate.of(2025, 9, 1),
                            endDate = LocalDate.of(2025, 12, 31),
                            status = RecruitmentStatus.OPEN,
                            viewCount = 0L,
